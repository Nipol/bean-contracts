...
describe('EIP712', () => {
  ...
  describe('eth_signTypedData_v4', () => {
    ...
    // it('should be success with plain type and salt', async () => {
    //   const walletAddress = await wallet.getAddress();
    ...
    // it('should be success with array type and salt', async () => {
    //   const walletAddress = await wallet.getAddress();
    ...
    // it('should be success with complex type and salt', async () => {
    //   const walletAddress = await wallet.getAddress();
